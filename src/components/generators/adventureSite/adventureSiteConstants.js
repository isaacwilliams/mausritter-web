...
export const SUMMARY_INHABITANT_GOAL = [
...
export const SUMMARY_SECRET_WITHIN = [
    'Deep within',
    'Hidden away',
    'Unknown to all',
    'Beneath',
...
export const SUMMARY_SECRET = [
    ['is a', 'monolith humming with arcane energy'],
    ['is a', 'preserved precursor beast'],
    ['are', 'signs of human experimentation'],
    ['is the', 'forgotten grave of an ancient queen'],
    ['is a', 'path into the veins of the earth'],
    ['is a', 'portal to the faerie realm'],
];

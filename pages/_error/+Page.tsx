...
import {
    ContentContainer,
    FlexContainer,
} from '../../src/components/layout/ContentContainer';
import { Title } from '../../src/components/styles/shared';
import BodyText from '../../src/components/styles/BodyText';

import lostMouseImage from '../../src/components/404page/lost-mouse.png';
